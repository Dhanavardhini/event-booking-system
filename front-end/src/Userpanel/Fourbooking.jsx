...
function Fourbooking() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const response = await axios.get('http://localhost/eventbackend/controllers/api/User/Get/fbook.php');
  ...
  return (
    <div className="main-book">
      <h1 className="h1two">🎭 Function Events</h1>
