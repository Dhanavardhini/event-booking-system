...
function BookForm() {
  ...
  useEffect(() => {
    setFormData((prevData) => ({
      ...prevData,
      event: event_name,  // Set event to event_name passed from Twobooking
      event_date: event_date,  // Set event_date
    }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost/eventbackend/controllers/api/User/post/enterbook.php",
        formData,
        {
  ...
  return (
    <div className="vr-body">
      <div className="vr-container">
        <h1 className="vr-title">Event Booking Form</h1>
