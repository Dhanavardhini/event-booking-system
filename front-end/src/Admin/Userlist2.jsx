...
function Userslist2() {
    ...
    const fetchEvents = async () => {
      try {
        const response = await axios.get(
          "http://localhost/eventbackend/controllers/api/admin/get/functioncount.php"
        );
  ...
  const handleSaveClick = async () => {
    try {
      await axios.put(
        "http://localhost/eventbackend/controllers/api/admin/put/functionupdate.php",
        editFormData
      );
  ...
  const handleDelete = async (id) => {
    try {
      const response = await axios.post(
        "http://localhost/eventbackend/controllers/api/admin/delete/functiondel.php",
        { id }
      );
